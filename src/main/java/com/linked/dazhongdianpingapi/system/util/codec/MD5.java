package com.linked.dazhongdianpingapi.system.util.codec;
...
public class MD5 {
	...
	public static boolean isValid(String encPass, String rawPass) {
		if (encPass.equals(encode(rawPass))) {
			return true;
		}
		return false;
	}
	...
	public static boolean isValid(String encPass, String rawPass,Object salt) {
		if (encPass.equals(encode(rawPass,salt))) {
			return true;
		}
		return false;
	}
...
////		System.out.println(encode("1","1"));
////		System.out.println(isValid("4416b6987fa8bc212c184b3797d06581","1","1"));
//		
//		//base64
//		Base64 base64 = new Base64();
